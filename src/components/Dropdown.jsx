...
const Dropdown = ({name, onChange, defaultVal}) => {
  return (
        <select className="w-full py-2 px-2 my-1 border-2 outline-0 transition-all ease-in focus:border-green-300 " name={name} 
        onChange={onChange} value={defaultVal}>
